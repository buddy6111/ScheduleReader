 ...
 *  3. EventCreator
 *  
 *  OAuthHelper : handles all transactions with the Google Calendar API
 *  ExcelFileReader : handles all data retrieval from the schedule
 *  EventCreator: handles the creation of events to be uploaded using the OAuthHelper
 * 
 * @author bkerk
 */

public class ScheduleReader extends JFrame implements ActionListener 
{
